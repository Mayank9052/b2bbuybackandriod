...
public partial class ExchangeCase
{
    ...
    // ── NEW: uploaded dealer documents (RC, ID proof, insurance, etc.) ──
    public virtual ICollection<ExchangeCaseDocument>    ExchangeCaseDocuments    { get; set; } = new List<ExchangeCaseDocument>();
}